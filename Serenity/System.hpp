...
public:
	...
	////// Class Member's //////
	HRESULT result;
	UINT Count;												// Counter for first time calls in loops.
...
public:
	...
	ID3D11DepthStencilView* mD3DDepthStencilView;			// pointer to the depth stencil view
